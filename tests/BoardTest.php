...
class BoardTest extends \PHPUnit\Framework\TestCase
{
    ...
    private array $boardSolutionLarge = array (
        0 =>
            array (
                0 => 1,
                1 => 2,
    ...
    private array $boardPrefillsLargeHalfSolved = array (
        0 =>
            array (
                0 => 1,
                1 => 2,
    ...
    {
        $this->board = new \Balsama\Nytpuzzlehelper\Board($this->boardDescriptionLarge, $this->boardPrefillsLargeHalfSolved);
    ...
    {
        $this->board = new \Balsama\Nytpuzzlehelper\Board($this->boardDescriptionSmall, $this->boardPrefillsSmall);
    }
    private function resetBoardLarge()
    {
        $this->board = new \Balsama\Nytpuzzlehelper\Board($this->boardDescriptionLarge, $this->boardPrefillsLarge);
    }
